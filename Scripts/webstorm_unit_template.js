...
#set ($_UICONF_ID = $UICONF_ID)
#if( "$!PARTNER_ID" == "" )
    #set ($_PARTNER_ID = 1666321)
#end
#if( "$!UICONF_ID" == "" )
    #set ($_UICONF_ID = 36762601)
#end
...
<!--Player main div-->
<script src="/mwEmbed/mwEmbedLoader.php/p/${PARTNER_ID}/sp/${PARTNER_ID}00/embedIframeJs/uiconf_id/${UICONF_ID}/partner_id/${PARTNER_ID}"></script>
<div id="details"
...
<div style="width:1125px; height: 360px; margin: auto;">
    <div id="kaltura_player_1466954509" style="width: 560px; height: 320px; float: left; border-width: 1px; border-style: solid; border-color: black; box-sizing: border-box;" itemprop="video" itemscope
         itemtype="http://schema.org/VideoObject">
        <span itemprop="name" content="Mad Max - Fury Road"></span>
        <span itemprop="description" content=""></span>
        <span itemprop="duration" content="153"></span>
        <span itemprop="thumbnail"
              content="http://cfvod.kaltura.com/p/${PARTNER_ID}/sp/${PARTNER_ID}00/thumbnail/entry_id/${ENTRY_ID}/version/100032/acv/531"></span>
    ...
    <div id="new"
        ...
        <button type="button" style="clear: none; margin-right: 10px; margin-bottom: 10px;" onclick=$("#analyticsLog").empty();>Clear log</button>
                <button type="button" style="clear: none; margin-right: 10px; margin-bottom: 10px;"
                onclick=doPlay()>Force Play
        </button><br>
        Entry ID changer: <form style="margin-top: 5px" id="formEntry" onsubmit="return false;">
        ...
        <br>
        KS Changer: <form style="margin-top: 5px" id="formKs" onsubmit="return false;">
